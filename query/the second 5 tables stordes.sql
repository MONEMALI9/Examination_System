...
AS
BEGIN
    INSERT INTO Question(question_txt, question_type, question_mark, Model_ans_id, Model_ans_txt)
...
AS
BEGIN
    INSERT INTO Exam (NO_of_questions, Exam_duration, Exam_grade, Exam_date, Crs_id)
