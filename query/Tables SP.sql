...
AS
BEGIN
    INSERT INTO Question(Quest_id, question_txt, Question_type, question_mark, Model_ans_id, Model_ans_txt)
...
BEGIN
    UPDATE Question
    SET question_txt = @Quest_txt,
        question_type = @Quest_type,
        question_mark = @Quest_mark,
...
AS
BEGIN
    INSERT INTO Exam (Exam_id, NO_of_questions, Exam_duration, Exam_grade, Exam_date, Crs_id)
...
AS
BEGIN 
    INSERT INTO Std_Answer (Std_id , Exam_id, Question_id, Std_ans, Std_qs_grade)
...
BEGIN 
    UPDATE Std_Answer
	SET Std_ans = @Std_ans_txt ,
		Std_qs_grade = @Std_qs_grade
	WHERE Std_id=@Std_id 
	AND Exam_id =@Exam_id
	AND question_id =@Quest_id
END 
...
AS
BEGIN
    INSERT INTO St_Exam_Grade (Std_id, Exam_id, Grade)
...
AS
BEGIN
    INSERT INTO KPI (KPI_id, Std_id, Std_Freelance_status, Freelance_salary , Cert_status)
...
BEGIN 
   UPDATE KPI 
    SET Std_Freelance_status = @Freelance_status,
